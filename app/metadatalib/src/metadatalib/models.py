...
class Submission(Base):
    ...
    project_id: Mapped[int] = mapped_column(ForeignKey('projects.project_id', onupdate='CASCADE', ondelete='CASCADE'))
    version: Mapped[int]
...
class Sample(Base):
    ...
    submission_id: Mapped[int] = mapped_column(ForeignKey('submissions.submission_id', onupdate='CASCADE', ondelete='CASCADE'))
...
class Annotation(Base):
    ...
    sample_accession: Mapped[int] = mapped_column(ForeignKey('samples.sample_accession', onupdate='CASCADE', ondelete='CASCADE'))
    attr: Mapped[str] = mapped_column(nullable=False)
